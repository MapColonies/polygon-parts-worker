import { bboxSchema, CORE_VALIDATIONS, featureSchema, INGESTION_VALIDATIONS, polygonSchema } from '@map-colonies/raster-shared';
import { z } from 'zod';
import { commaSeparatedStringSchema, flexibleDateCoerce } from './common.schema';

export const shpFeaturePropertiesSchema = z.object({
  id: z.string().uuid({ message: 'ID should be a valid UUID' }),
...
// export const shpFeaturePropertiesSchema = z
//   .object({
//     id: z.string().uuid({ message: 'ID should be a valid UUID' }),
